                        ...
                        <div id="team-text-modal-<?php echo $k;?>" class="modal-wrapper">
                            <div class="modal team-modal modal--primary">
                                ...
                                <div class="modal-content">
                                    <header class="heading heading--sm heading--no-stripe heading--centered team-header team-text-header">
                                        <img src="<?php echo THEME; ?>/images/icons/user.png" alt="" class="heading-avatar"/>
                                        <h3 class="heading-h">
                                            <span class="heading-title"><?php the_title(); ?></span>
                                            <span class="heading-tagline"><?php echo $role;?></span>
                                        </h3>
                                    </header>
                                    <p class="dp body-text team-modal-content"><?php echo get_the_content();?></p>
                                </div>
                            </div>
                        </div>
