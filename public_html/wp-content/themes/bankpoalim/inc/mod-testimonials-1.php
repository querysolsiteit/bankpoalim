...
?>
    ...
    <?php while($members_query->have_posts()): $members_query->the_post();
        ...
        <?php ob_start();  // don't print image yet ?>
            <img src="<?php echo $logo['url']; ?>" alt="" class="db">
        ...
        <?php
            ...
            if($count_rows%2 == 0){ // even row
                if($k_inner == 0){
                    ...
                    $col_2_class = 'col-img col-logo align-center';
                ...
                if($k_inner == 0){
                    $col_1_class = 'col-img col-logo align-center';
                    $col_1_content = $buffer_image;
                    $col_2_class = 'col-text arrow--left';
                    $col_2_content = $buffer_content;
                }
                elseif($k_inner == 1){
                    $col_1_class = 'col-img col-logo align-center reorder-md';
                    $col_1_content = $buffer_image;
                    $col_2_class = 'col-text arrow--left';
                    $col_2_content = $buffer_content;
                }
