...
function locations_post_type() {
	...
	$labels = array(
		'name'                  => _x( 'Locations', 'Post Type General Name', 'kolnoa' ),
		'singular_name'         => _x( 'Location', 'Post Type Singular Name', 'kolnoa' ),
		'menu_name'             => __( 'Locations', 'kolnoa' ),
		'name_admin_bar'        => __( 'Locations', 'kolnoa' ),
		'archives'              => __( 'Item Archives', 'kolnoa' ),
		'parent_item_colon'     => __( 'Parent Item:', 'kolnoa' ),
		'all_items'             => __( 'All Items', 'kolnoa' ),
		'add_new_item'          => __( 'Add New Item', 'kolnoa' ),
