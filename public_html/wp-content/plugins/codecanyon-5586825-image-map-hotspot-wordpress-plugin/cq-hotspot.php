    ...
    public function add_metaboxes(){
        ...
        function cq_hotspot_save_hotspot_post($id){
            ...
            if(isset($_POST['cq_hotspot_setting'])){
                ...
                $setting_arr = array(
                    'cq_hotspot_animation'       => isset($_POST['cq_hotspot_animation']) ? $_POST['cq_hotspot_animation']             :'',
                    'cq_hotspot_autodelay'       => isset($_POST['cq_hotspot_autodelay']) ? $_POST['cq_hotspot_autodelay']             : '',
                    'cq_hotspot_delaytime'       => isset($_POST['cq_hotspot_delaytime']) ? $_POST['cq_hotspot_delaytime']             : '',
                    'cq_hotspot_loop'            => isset($_POST['cq_hotspot_loop']) ? $_POST['cq_hotspot_loop']                       : '',
                    'cq_hotspot_triggerby'       => isset($_POST['cq_hotspot_triggerby']) ? $_POST['cq_hotspot_triggerby']             : '',
                    'cq_hotspot_sticky'          => isset($_POST['cq_hotspot_sticky']) ? $_POST['cq_hotspot_sticky']                   : '',
                    'cq_hotspot_autohide'        => isset($_POST['cq_hotspot_autohide']) ? $_POST['cq_hotspot_autohide']               : '',
                    'cq_hotspot_autohide_delay'  => isset($_POST['cq_hotspot_autohide_delay']) ? $_POST['cq_hotspot_autohide_delay']   : '',
                    'cq_hotspot_arrowstyle'      => isset($_POST['cq_hotspot_arrowstyle']) ? $_POST['cq_hotspot_arrowstyle']           : '',
                    'cq_hotspot_dropinease'      => isset($_POST['cq_hotspot_dropinease']) ? $_POST['cq_hotspot_dropinease']           : '',
                    'cq_hotspot_displayvideo'    => isset($_POST['cq_hotspot_displayvideo']) ? $_POST['cq_hotspot_displayvideo']       : '',
                    'cq_hotspot_pulsecolor'      => isset($_POST['cq_hotspot_pulsecolor']) ? $_POST['cq_hotspot_pulsecolor']           : '',
                    'cq_hotspot_customicon'      => isset($_POST['cq_hotspot_customicon']) ? $_POST['cq_hotspot_customicon']           : '',
                    'cq_hotspot_clickimageclose' => isset($_POST['cq_hotspot_clickimageclose']) ? $_POST['cq_hotspot_clickimageclose'] : ''
                );
